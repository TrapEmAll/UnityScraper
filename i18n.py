...
TRANSLATIONS = {
    'en': {
        ...
        'use_https': 'Use HTTPS (with HTTP fallback)',
        ...
        'status_connected_https': '✓ Connected via HTTPS',
    ...
    'es': {
        ...
        'use_https': 'Usar HTTPS (con reserva HTTP)',
        ...
        'status_connected_https': '✓ Conectado vía HTTPS',
    ...
    'fr': {
        ...
        'use_https': 'Utiliser HTTPS (avec secours HTTP)',
        ...
        'status_connected_https': '✓ Connecté via HTTPS',
    ...
    'de': {
        ...
        'use_https': 'HTTPS verwenden (mit HTTP-Fallback)',
    ...
    'ja': {
        ...
        'max_retries': '最大再試行:',
        'bandwidth': '帯域幅 (KB/s):',
        'use_https': 'HTTPS を使用 (HTTP フォールバック付き)',
